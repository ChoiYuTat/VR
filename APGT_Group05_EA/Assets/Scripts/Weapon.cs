...
public class Weapon : MonoBehaviour
{
    ...
    void ChangeSettings()
    {
        ...
        rb.isKinematic = (Shooting.instance.weapon == this) ? true : false;
        rb.interpolation = (Shooting.instance.weapon == this) ? RigidbodyInterpolation.None : RigidbodyInterpolation.Interpolate;
        collider.isTrigger = (Shooting.instance.weapon == this);
    }
    ...
    public void Shoot(Vector3 pos, Quaternion rot, bool isEnemy)
    {
        ...
        if (!Shooting.instance.weapon == this)
            bulletAmount--;

        GameObject bullet = Instantiate(Shooting.instance.bulletPrefab, pos, rot);
    ...
    public void Pickup()
    {
        ...
        Shooting.instance.weapon = this;
        ChangeSettings();

        transform.parent = Shooting.instance.weaponHolder;
    ...
    IEnumerator Reload()
    {
        if (Shooting.instance.weapon != this)
            yield break;
        Shooting.instance.ReloadUI(reloadTime);
        reloading = true;
